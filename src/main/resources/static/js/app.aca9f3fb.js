(function (t) {
    function e(e) {
        for (var s, i, o = e[0], c = e[1], l = e[2], u = 0, d = []; u < o.length; u++) i = o[u], r[i] && d.push(r[i][0]), r[i] = 0;
    ...
    function i(t) {
        return o.p + "/static/js/" + ({}[t] || t) + "." + {
            "chunk-2d0e1801": "690ce99f",
            "chunk-2d20ef09": "6f9a8754",
            "chunk-2d213e5c": "799b9720",
            "chunk-f5d26d7c": "b872f1c4"
        }[t] + ".js"
    }
    ...
    o.e = function (t) {
        ...
        if (0 !== a) if (a) e.push(a[2]); else {
            ...
            c.charset = "utf-8", c.timeout = 120, o.nc && c.setAttribute("nonce", o.nc), c.src = i(t), n = function (e) {
    ...
    0: function (t, e, a) {
        ...
        }), i = n, o = a("2877"), c = Object(o["a"])(i, s, r, !1, null, null, null);
        e["default"] = c.exports
    }, 1196: function (t, e, a) {
        "use strict";
        var s = a("1d1c"), r = a.n(s);
        r.a
    }, "173d": function (t) {
        ...
        var s = function () {
                ...
                return a("div", ["stats" !== t.chartDetail.type ? a("material-card", t._g(t._b({
                    ...
                    attrs: {"align-center": "", "justify-center": "", row: "", "fill-height": ""}
                    ...
                    attrs: {items: t.compareTime, label: "选择同比", "item-text": "t", "item-valie": "v"},
                    model: {
                        value: t.compareText, callback: function (e) {
                            t.compareText = e
                        }, expression: "compareText"
                    }
                })], 1) : t._e()], 1)], 1)], 1) : t._e(), "stats" === t.chartDetail.type ? a("material-stats-card", {
                    ref: "chart-stats",
                    attrs: {
                        color: "green",
                        icon: "mdi-store",
            ...
            }, r = [], n = a("e814"), i = a.n(n), o = (a("a481"), a("6762"), a("2fdb"), a("2d1f")), c = a.n(o),
            l = (a("55dd"), a("6b54"), a("7f7f"), a("b6d0")), u = a.n(l), f = a("a4bb"), d = a.n(f),
            m = (a("7514"), a("ac6a"), a("f891")), p = a("c3da"), h = a.n(p), v = a("40ea"), b = a.n(v), g = a("947c"),
            y = a.n(g), x = a("c1df"), w = 18e5, j = 36e5, k = 216e5, _ = 432e5, D = 864e5, T = 2592e5, I = 6048e5,
            C = 80352e5, $ = [{min: -1, max: w, options: ["1分钟", "2分钟", "5分钟"]}, {
                min: w,
                max: j,
            ...
            S = [{type: "line", height: 80}, {type: "pie", height: 115}, {type: "funnel", height: 95}], O = {
                inheritAttrs: !1,
                ...
                computed: {
                    readyToShow: function () {
                        ...
                        return t.push({
                            ...
                            key: "xAxis",
                            sortable: !0
                        }), d()(this.chartData.rows[0]).filter(function (t) {
                            return "xAxis" !== t
                        }).forEach(function (e) {
                ...
                methods: {
                    getMetric: function () {
                        ...
                        if (this.chartId) {
                            ...
                            a.add("xAxis"), m["a"].getViewByChart(1, e).then(function (e) {
                                console.log("图表".concat(t.chartDetail.name), e), t.metricList = e.metricList, t.calMetric()
                            }).catch(function (e) {
                        ...
                        if (e.add("xAxis"), "stats" !== this.chartDetail.type) {
                            if (this.metricList.sort(function (t, e) {
                                ...
                                var s = {}, r = t.queryTime.interval.endTime - t.queryTime.interval.startTime;
                                s.xAxis = r >= D ? x(a.timestamp).format("MM/DD H:mm ") : x(a.timestamp).format("H:mm "), a.data.forEach(function (a) {
                                    var r = c()(a);
                                    r.forEach(function (a) {
                                        var n = a[0], i = a[1];
                                        if (t.metrics.includes(n)) {
                                            var o = n + "『";
                                            r.forEach(function (e) {
                                                t.dimensions.includes(e[0]) && (o = o + e[0] + ":" + e[1] + ".")
                                            }), o += "』", o = o.replace("『』", ""), s[o] = i, e.add(o)
                                        }
                                    })
                                ...
                                n.forEach(function (a) {
                                    var n = a[0], o = a[1];
                                    t.metrics.includes(n) && (s[n] = "funnel" === t.chartDetail.type && "数量" === n ? i()(o) : o, e.add(n)), t.dimensions.includes(n) && (r = 1 === t.dimensions.length ? o : r + n + ":" + o + ".")
                                }), s.xAxis = r, t.chartData.rows.push(s)
                            ...
                            var s = this.metricList[0].data[0], r = this.metrics[0];
                            console.log("data:"), console.log(s), console.log(s[r]), this.chartData = s[r].toString()
                        }
                    }, clear: function () {
                        ...
                        var a = this;
                        if (console.log("".concat(this.chartDetail.name, "开始更新大小")), this.chartDetail && "stats" !== this.chartDetail.type) {
                            console.log(this.$refs);
                            var s = this.$refs["chart-name"].clientHeight, r = this.$refs["chart-desc"].clientHeight,
                                n = S.find(function (t) {
                                    return t.type === a.chartDetail.type
                                }).height, i = t - s - r - n;
                            this.$nextTick(function (t) {
                                var e = a.$refs["chart"];
                                e && (e.height = i + "px", e.echarts.resize())
                            })
                        }
                    }
                },
            ...
            }, L = O, E = (a("ad75"), a("2877")), N = Object(E["a"])(L, s, r, !1, null, null, null);
        e["default"] = N.exports
    }, "25f5": function (t, e, a) {
        "use strict";
        var s = a("453f"), r = a.n(s);
        r.a
    }, 2609: function (t, e, a) {
        "use strict";
        a.r(e), e["default"] = {
        ...
        a.r(e);
        a("28a5");
        var s = a("768b"), r = (a("a481"), a("ac6a"), a("c653")), n = {};
        r.keys().forEach(function (t) {
            if ("./index.js" !== t) {
                var e = t.replace(/(\.\/|\.js)/g, ""), a = e.split("/"), i = Object(s["a"])(a, 2), o = i[0], c = i[1];
                n[o] || (n[o] = {namespaced: !0}), n[o][c] = r(t).default
            }
        }), e["default"] = n
    }, "2c37": function (t, e, a) {
    }, 4025: function (t, e, a) {
        ...
        var s = function () {
            ...
            computed: Object(n["a"])({}, Object(i["c"])("app", ["image", "color"]), {
                inputValue: {
                    get: function () {
            ...
            methods: Object(n["a"])({}, Object(i["b"])("app", ["setDrawer", "toggleDrawer"]), {
                onResponsiveInverted: function () {
                    window.innerWidth < 991 ? this.responsive = !0 : this.responsive = !1
                }
            })
        }, c = o, l = (a("ff57"), a("2877")), u = Object(l["a"])(c, s, r, !1, null, null, null);
        e["default"] = u.exports
    }, "42e7": function (t, e, a) {
        "use strict";
        a.r(e);
        ...
        }, r = [], n = a("cebc"), i = a("e3a9"), o = {
            inheritAttrs: !1,
            props: Object(n["a"])({}, i["default"].props, {
        ...
        }, c = o, l = (a("4d79"), a("2877")), u = Object(l["a"])(c, s, r, !1, null, null, null);
        e["default"] = u.exports
    }, 4360: function (t, e, a) {
        "use strict";
        var s = a("2b0e"), r = a("2f62"), n = {
            alert: function (t, e) {
                var a = t.commit;
        ...
        s["default"].use(r["a"]);
        var u = new r["a"].Store({actions: n, getters: i, modules: o["default"], mutations: c, state: l});
        e["a"] = u
    }, 4394: function (t, e, a) {
        "use strict";
        a.r(e);
        ...
        }, r = [], n = a("4093"), i = a("f891"), o = {
            components: {VariableTable: n["default"]}, data: function () {
                return {
                    btnLoading: !1,
                    active: 0,
                ...
                clear: function () {
                    ...
                    i["c"].listFields(a).then(function (e) {
                    ...
                    if (0 === this.active) this.btnLoading = !0, this.getFields(); else {
                        ...
                        this.params.dimensionList = e.filter(function (t) {
                            ...
                            return t.field
                        }), console.log(this.params), i["c"].add(this.params).then(function (e) {
                            t.$emit("add_over"), t.clear()
                        })
                    }
                }
            }
        }, c = o, l = a("2877"), u = Object(l["a"])(c, s, r, !1, null, null, null);
        e["default"] = u.exports
    }, "453f": function (t, e, a) {
    }, 4678: function (t, e, a) {
        var s = {
        ...
        r.keys = function () {
            return Object.keys(s)
        }, r.resolve = n, t.exports = r, r.id = "4999"
    }, "4d79": function (t, e, a) {
        "use strict";
        var s = a("803b"), r = a.n(s);
        r.a
    }, "56d7": function (t, e, a) {
        "use strict";
        a.r(e);
        a("cadf"), a("551c"), a("f751"), a("097d");
        var s = a("2b0e"), r = (a("a481"), a("ac6a"), a("8103")), n = a.n(r), i = a("bba4"), o = a.n(i), c = a("ffe0");
        c.keys().forEach(function (t) {
            var e = c(t), a = n()(o()(t.replace(/^\.\//, "").replace(/\.\w+$/, "")));
            s["default"].component(a, e.default || e)
        });
        var l = a("bc3a"), u = a.n(l);
        s["default"].prototype.$http = u.a;
        var f = a("ce5b"), d = a.n(f), m = {
            primary: "#4caf50",
            secondary: "#4caf50",
            tertiary: "#495057",
            accent: "#82B1FF",
        ...
        a("bf40"), a("5363");
        s["default"].use(d.a, {iconfont: "mdi", theme: m});
        ...
        try {
            for (var $, S = function () {
                ...
                e.reduce(function (a, s, r) {
                    return a[s] ? a[s] : (a[s] = r + 1 === e.length ? _(t) : {}, a[s])
                }, D)
        ...
        var L = D;
        s["default"].use(w["a"]);
        var E = new w["a"]({locale: "en", fallbackLocale: "en", messages: L}), N = E, q = (a("7f7f"), a("8c4f")),
            M = a("0a89"), A = a.n(M), z = [{path: "/user-profile", name: "User Profile", view: "UserProfile"}, {
                path: "/table-list",
                name: "Table List",
                view: "TableList"
        ...
        s["default"].use(A.a);
        var U = V, P = a("4360");
        Object(p["sync"])(P["a"], U), s["default"].config.productionTip = !1, new s["default"]({
            i18n: N,
            router: U,
            store: P["a"],
            render: function (t) {
        ...
        e["default"] = {setDrawer: s("drawer"), setImage: s("image"), setColor: s("color"), toggleDrawer: r("drawer")}
    }, "68c7": function (t, e, a) {
        "use strict";
        a.r(e);
        var s = function () {
            ...
            return a("form", {staticStyle: {padding: "24px"}}, [a("v-select", {
                ...
                })], 1), a("v-flex", {attrs: {md3: "", lg3: "", xs12: ""}}, [a("v-text-field", {
                    attrs: {
                        label: "别名",
                        required: ""
                    }, model: {
                ...
                }, [t.params.aggregations.length === s + 1 ? a("v-btn", {
                    attrs: {flat: "", color: "success"},
                    on: {click: t.putNewEmptyAggregation}
                }, [t._v("新增指标\n                ")]) : t._e(), a("v-btn", {
                    attrs: {flat: "", color: "error"},
                    on: {
                        click: function (e) {
                            return t.params.aggregations.splice(s, 1)
                        }
                    }
        ...
        }, r = [], n = (a("6762"), a("2fdb"), a("7514"), a("f891")), i = {
            props: ["dashboardId"], watch: {
                "params.datasourceId": {
                    handler: function (t, e) {
                        console.log("datasource发生了变更:".concat(this.params.datasourceId)), 0 !== this.params.datasourceId && (this.params.aggregations.length < 1 && this.putNewEmptyAggregation(), this.params.dimensions.length < 1 && this.putNewEmptyDimension())
                    }, deep: !0
                }
            }, computed: {
                ...
                getAggregationsTypeOption: function (t) {
                    ...
                    }), this.params.dashboardId = this.dashboardId, console.log(this.params), "pie" !== this.params.type && (this.params.threshold = 200), "funnel" === this.params.type && (this.params.aggregations = [{}]), n["a"].add(this.params).then(function (e) {
                        t.newChartId = e, console.log("提交成功,图表id=" + t.newChartId), t.$emit("chart_submit", t.newChartId), t.clear()
                    })
                }, getDatasources: function () {
                    var t = this;
                    n["c"].list().then(function (e) {
                        t.datasources = e
                    })
                }
            }, mounted: function () {
        ...
        }, o = i, c = a("2877"), l = Object(c["a"])(o, s, r, !1, null, null, null);
        e["default"] = l.exports
    }, "6b35": function (t, e, a) {
    }, "703d": function (t, e, a) {
    }, "803b": function (t, e, a) {
        ...
        }, i = n, o = (a("ee4f"), a("2877")), c = Object(o["a"])(i, s, r, !1, null, null, null);
        e["default"] = c.exports
    }, a38c: function (t, e, a) {
        "use strict";
        a.r(e);
        var s = function () {
            ...
            props: ["label", "defaultDate"], computed: {}, watch: {}, data: function () {
                ...
                confirm: function () {
                    ...
                    this.wholeDate = n(this.defaultDate).format("YYYY-MM-DD HH:mm"), this.date = n(this.defaultDate).format("YYYY-MM-DD"), this.time = n(this.defaultDate).format("HH:mm")
                }
            }, mounted: function () {
                this.trans()
            }
        ...
        r.keys = function () {
            return Object.keys(s)
        }, r.resolve = n, t.exports = r, r.id = "c653"
    }, c6cc: function (t, e, a) {
        "use strict";
        a.r(e);
        var s = function () {
        ...
        }), i = n, o = (a("1196"), a("2877")), c = Object(o["a"])(i, s, r, !1, null, null, null);
        e["default"] = c.exports
    }, cb2c: function (t, e, a) {
        "use strict";
        var s = a("4025"), r = a.n(s);
        r.a
    }, d23b: function (t, e, a) {
        "use strict";
        a.r(e);
        ...
        }, c = o, l = (a("25f5"), a("2877")), u = Object(l["a"])(c, s, r, !1, null, null, null);
        e["default"] = u.exports
    }, e3a9: function (t, e, a) {
        "use strict";
        a.r(e);
        ...
        }), i = n, o = (a("cb2c"), a("2877")), c = Object(o["a"])(i, s, r, !1, null, null, null);
        e["default"] = c.exports
    }, ee4f: function (t, e, a) {
        "use strict";
        var s = a("703d"), r = a.n(s);
        r.a
    }, f26b: function (t) {
        ...
        var s = a("795b"), r = a.n(s), n = a("f499"), i = a.n(n), o = a("bc3a"), c = a.n(o), l = a("4360"),
            u = c.a.create({});
        u.interceptors.response.use(function (t) {
            ...
            console.log("error"), console.log(t), console.log(i()(t));
            var e = JSON.parse(i()(t)).response.status, a = e.message,
                s = 404 === JSON.parse(i()(t)).response.status ? "访问的资源不存在" : a && "No message available" === a ? "网络出错，请重试" : "服务器开小差了";
            return l["a"].dispatch("alert", {type: "error", content: s}), r.a.reject(t)
        });
        var f = {
        ...
        r.keys = function () {
            return Object.keys(s)
        }, r.resolve = n, t.exports = r, r.id = "ffe0"
    }
});